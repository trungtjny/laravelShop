...
@section('content')
    ...
    <div class="row">
        <div class="col-8  p-3 border">
            ...
            <hr>
            <form action="{{route('admin.savemember',['id' => $user->id])}}" method="POST">
                @csrf
                <div class="row " >
                    <div class="col-7">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6 mb-4">
                                        ...
                                        <input type="text" name="fname" class="form-control" placeholder="Nhập họ, tên đệm" value="{{$user->fname}}">
                                        @if ($errors->any('fname'))
                                    ...
                                    <div class="col-6 mb-4">
                                        ...
                                        <input type="text" name="lname" class="form-control" placeholder="Tên " value="{{$user->lname}}">
                                        @if ($errors->any('lname'))
                                    ...
                                    <div class="col-6 mb-4">
                                        ...
                                        <input type="text" name="phone" class="form-control" placeholder="0123456789" value="{{$user->phone}}">
                                        @if ($errors->any('phone'))
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <input type="text" name="email" class="form-control" placeholder="email đăng nhập" value="{{$user->email}}">
                                        @if ($errors->any('address'))
